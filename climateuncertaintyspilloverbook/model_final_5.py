...
from src.model_tech_dice import hjb_post_damage_post_tech, hjb_post_damage_pre_tech, hjb_pre_damage_post_tech, hjb_pre_damage_pre_tech
...
for i, γ_3_i in enumerate(γ_3):
    ...
    if i == 0:
        ...
        v_guess = model_res['v']
    model_res = hjb_post_damage_post_tech(k_grid, y_grid_long, model_args, v_guess, 1., .05,
                                          1e-6, 2000, False)
