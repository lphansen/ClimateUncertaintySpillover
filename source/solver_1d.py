...
@njit
def upwind_1d(LHS, A, B, C, i, dx, ϵ):
    """
...
@njit
def construct_matrix_1d(A, B, C, D, v0, ϵ, dx, bc, impose_bc):
    """
    ...
    for i in range(I):
        if i == 0 and impose_bc[0]:
            ...
            LHS = upwind_1d(LHS, A, B, C, i, dx, ϵ)
    return LHS, RHS


def false_transient_one_iteration_python(A, B, C, D, v0, ϵ, dx, bc, impose_bc):
    LHS, RHS = construct_matrix_1d(A, B, C, D, v0, ϵ, dx, bc, impose_bc)
