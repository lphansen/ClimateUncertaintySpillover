...
def solve_hjb_y_old(y, model_args=(), v0=None, ϵ=1., tol=1e-8, max_iter=10_000, print_iteration=True):
    r"""
    Solve the HJB that is only related to y.
    y is the accumulative change of temperature.
...
def solve_hjb_y_jump_old(y, model_args=(), v0=None, ϵ=.5, tol=1e-8, max_iter=10_000, print_iteration=True):
    r"""
